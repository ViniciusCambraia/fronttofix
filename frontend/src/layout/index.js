...
const useStyles = makeStyles((theme) => ({
  ...
  drawerPaper: {
    ...
    borderRight: `1px solid ${theme.palette.mode === 'light' ? 'rgba(0,0,0,0.08)' : 'rgba(255,255,255,0.05)'}`,
    boxShadow: theme.palette.mode === 'light' ? '4px 0 10px rgba(0,0,0,0.02)' : 'none',
  },
  drawerPaperClose: {
    overflowX: "hidden",
    transition: theme.transitions.create("width", {
